...
These examples pin to the released tag `v0.1.4` <!-- x-release-please-version -->. For production, pin to a commit
SHA — `uses: Binclusive/a11y@<sha>  # v0.1.4` <!-- x-release-please-version --> — so a moved tag can't change what
