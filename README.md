...
> `@v0.3.0`. <!-- x-release-please-version --> For production, pin to a commit SHA — `uses:
> Binclusive/a11y@<sha>  # v0.3.0` <!-- x-release-please-version --> — rather than a floating tag or branch, so a
