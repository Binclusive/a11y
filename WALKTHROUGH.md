...
Almost nobody ships raw MUI or Radix. Real apps have their *own* design system — `@acme/ui`, `@company/components`, whatever. So this is the real adoption story, start to finish: how the checker meets a team like that, from the first cold scan to running quietly behind every commit.
