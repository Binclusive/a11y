 ...
 * touches the Unity path — the producer (`unity-ast.ts`, `collect-unity.ts`,
 * `unity-guid-registry.ts`) OR a finding rule the #88 aggregator runs
 * (`unity-rule-color-only.ts`, `unity-rule-missing-label.ts`,
 * `unity-rules-baseline.ts`, `unity-findings.ts`).
 *
